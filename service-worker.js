...
const ASSETS = [
  ...
  './js/core/numbers.js',
  './js/core/pdf/authorityCharts.js',
  './js/core/pdf/authorityCorporateBlock.js',
  './js/core/pdf/authorityCoverPage.js',
  './js/core/pdf/authorityExecutiveSummary.js',
  './js/core/pdf/authorityHeaderPolicy.js',
  './js/core/pdf/authorityHighlightPolicy.js',
  './js/core/pdf/authorityLargeDocument.js',
  './js/core/pdf/authorityPagination.js',
  './js/core/pdf/authorityPdfReport.js',
  './js/core/pdf/authorityReportPolicy.js',
  './js/core/pdf/authorityReportScope.js',
  ...
  './js/modules/f-gases-check/reportAdapter.js',
  './js/modules/f-gases-check/results.js',
  './js/modules/f-gases-check/savedRecords.js',
  './js/modules/f-gases-check/schema.js',
  './js/modules/f-gases-check/state.js',
  './js/modules/f-gases-check/view.js',
  './js/modules/flooding-verification/calculationAdapter.js',
  './js/modules/flooding-verification/config.js',
  './js/modules/flooding-verification/controller.js',
  './js/modules/flooding-verification/diagnosticModel.js',
  './js/modules/flooding-verification/dynamicRenderer.js',
  './js/modules/flooding-verification/index.js',
  './js/modules/flooding-verification/interpretationModel.js',
  './js/modules/flooding-verification/logic.js',
  './js/modules/flooding-verification/plausibilityModel.js',
  './js/modules/flooding-verification/reportAdapter.js',
  './js/modules/flooding-verification/results.js',
  './js/modules/flooding-verification/retentionApplicability.js',
  './js/modules/flooding-verification/retentionDurationComparison.js',
  './js/modules/flooding-verification/retentionFactors.js',
  ...
  './js/modules/rainwater/reportAdapter.js',
