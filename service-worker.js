const CACHE_NAME = 'techcalc-pro-1.3.1-beta.2';
const CACHE_REVISION = '1.3.1-beta.2-version-1-3-1-beta-2-dashboard-tss-system-icons-ui-controls';
const ASSETS = [
  './',
  './index.html',
  './manifest.json',
  ...
  './assets/icons/tss/arrow-clockwise.svg',
  './assets/icons/tss/bell.svg',
  './assets/icons/tss/bolt.svg',
  './assets/icons/tss/calculator.svg',
  './assets/icons/tss/chart.svg',
  './assets/icons/tss/checkmark-circle.svg',
  './assets/icons/tss/chevron-down.svg',
  './assets/icons/tss/chevron-left.svg',
  './assets/icons/tss/chevron-right.svg',
  './assets/icons/tss/chevron-up.svg',
  './assets/icons/tss/clock.svg',
  './assets/icons/tss/cube.svg',
  './assets/icons/tss/cylinder.svg',
  './assets/icons/tss/doc.svg',
  './assets/icons/tss/drop.svg',
  './assets/icons/tss/ellipsis.svg',
  './assets/icons/tss/folder.svg',
  './assets/icons/tss/gauge.svg',
  './assets/icons/tss/gear.svg',
  './assets/icons/tss/grid.svg',
  './assets/icons/tss/info.svg',
  './assets/icons/tss/magnifyingglass.svg',
  './assets/icons/tss/pencil.svg',
  './assets/icons/tss/pipe.svg',
  './assets/icons/tss/plus.svg',
  './assets/icons/tss/share.svg',
  './assets/icons/tss/sliders.svg',
  './assets/icons/tss/snowflake.svg',
  './assets/icons/tss/star.svg',
  './assets/icons/tss/thermometer.svg',
  './assets/icons/tss/trash.svg',
  './assets/icons/tss/warning.svg',
  './assets/icons/tss/waves.svg',
  './assets/icons/tss/xmark.svg',
  './docs/legal/agb.html'
];
