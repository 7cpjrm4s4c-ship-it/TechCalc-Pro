const CACHE_NAME = 'techcalc-pro-1.0.1-release-feedback';
const ASSETS = [
  './','./index.html','./manifest.json','./release-notes.json',
  './css/tokens.css','./css/layout.css','./css/components.css','./css/modules.css',
  './js/core/app.js','./js/core/version.js','./js/core/releaseNotes.js','./js/core/feedbackModal.js','./js/core/registry.js','./js/core/router.js','./js/core/renderer.js','./js/core/preferences.js','./js/core/state.js','./js/core/navigation.js','./js/core/projectStorage.js','./js/core/pdfExport.js',
