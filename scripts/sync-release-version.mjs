...
const versionModulePath = path.join(root, 'core/version.js');
const appPath = path.join(root, 'core/app.js');
const floodingReportPath = path.join(root, 'modules/flooding-verification/reportAdapter.js');
const releaseNotesControllerPath = path.join(root, 'core/ux/releaseNotesController.js');
