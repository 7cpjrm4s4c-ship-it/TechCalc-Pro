...
const modules = moduleIds.map(id => {
  ...
  return {
    ...
    usesCentralSavedRecords: fullText.includes('savedRecords.js') || fullText.includes('savedRecordController') || fullText.includes('savedCalculationController') || fullText.includes('createLineSectionController') || fullText.includes('lineSectionController'),
