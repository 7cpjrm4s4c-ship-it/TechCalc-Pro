# TechCalc Pro 1.3.2-dev.2 - Quality Gates / Marktreife
...
- Neue Module muessen den Modulvertrag 1.3.2-dev.2 verwenden.
...
Der UI-Audit meldet in Phase 5 weiterhin Legacy-Klassen wie `dw-*`, `ph-*`, `hx-*`, `rainwater-*` und `wastewater-*`. Das ist fuer bestehende Module noch toleriert, aber ab 1.3.2-dev.2 gilt:
