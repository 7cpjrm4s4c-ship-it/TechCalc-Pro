...
Phase 37 ist releasefähig abgeschlossen. Die verbleibenden nächsten Schritte sind keine Stabilisierungsblocker mehr, sondern RC-/Release-Prozessschritte: finaler manueller Mobile-Test, Hosting-Deploy, Cache-Update-Test und Tagging von `1.3.0-rc.1`.
