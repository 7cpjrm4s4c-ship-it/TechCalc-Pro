...
export function renderCollectionItem(item = {}, definition = {}, collection = '') {
  ...
  const editHtml = editable ? `<button type="button" data-tc-action="platform:collection:edit" data-collection="${esc(collection)}" data-collection-id="${esc(id)}" aria-label="${esc(editLabel)}">✎</button>` : '';
