...
export const pipeSystems = [
  ...
  { id:'plastic', label:'PE 100 SDR 11', normSmall:'DIN EN ISO 15494', normLarge:'DIN EN ISO 15494', roughness:0.007, maxDn:160, dimensions: steelDimensions.filter(p => p.dn <= 150) }
];
