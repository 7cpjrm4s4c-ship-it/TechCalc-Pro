...
import { pipeSystems, dnTable, recommendPipe } from '../utils/pipes.js';
import refrigerantService from '../utils/refrigerants/refrigerant-service.js';
...
export const frameworkDataCatalog = createDataCatalog();

export default frameworkDataCatalog;
