...
export const wastewaterSchema = defineFormSchema({
  fields: [
    ...
    { key:'lineType', label:'Leitungsart', type:FIELD_TYPES.SELECT, options:lineTypeOptions, commit:'immediate', lookup:true },
  ...
  groups: [
    ...
    { title:'Leitungsart / Randbedingungen', fields:['lineType','branchType','fillRatio','slopeCmM','pipeLengthM','bends90'], columns:2, accent:'green' },
