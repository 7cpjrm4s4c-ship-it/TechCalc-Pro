...
const recurrenceOptions = [
  { value: '', label: 'Bemessungshäufigkeit wählen' },
  { value: '1', label: 'n = 1,0/a (T = 1 a)' },
  { value: '0,5', label: 'n = 0,5/a (T = 2 a)' },
  { value: '0,2', label: 'n = 0,2/a (T = 5 a)' },
  { value: '0,1', label: 'n = 0,1/a (T = 10 a)' }
];
const riskOptions = [
