...
export function buildFGasesReportDto({ state = {}, calculation = {}, generatedAt = new Date().toISOString() } = {}) {
  ...
  return Object.freeze({
    metadata: { dtoType: 'techcalc.f-gases-check.report', dtoVersion: F_GASES_REPORT_DTO_VERSION, moduleId: config.id, moduleTitle: config.title, schemaVersion: state.schemaVersion ?? F_GASES_SCHEMA_VERSION, generatedAt },
