...
export default defineModuleConfig({
  ...
  migrationStatus: 'phase-16e-event-pipeline-consolidation phase-20b1-platform-mount phase-20b2-saved-record-controller phase-20b3-result-renderer phase-20c-dynamic-renderer phase-20d-platform-contract',
