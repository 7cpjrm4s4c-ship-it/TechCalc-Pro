...
function savedPlantsCard(s){
  return card('Anlagen speichern', stack([
    ...
    `<div class="tc-save-actions"><button type="button" class="action-button" data-ph-save ${s.activePlantId ? 'disabled' : ''}>Speichern</button><button type="button" class="action-button" data-ph-update ${s.activePlantId ? '' : 'disabled disabled'}>Aktualisieren</button></div>`,
