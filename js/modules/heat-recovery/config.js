...
export default defineModuleConfig({
  ...
  migrationStatus: 'phase-24b2-result-renderer-dynamic-islands phase-24b3-dynamic-controller-hardening phase-24c-platform-contract-finalization phase-24d-hardening',
  capabilities: [
