...
import { collectCurrentModule, reportSections } from '../core/pdf/pdfDataMapping.js';
...
const appSource = await readFile(new URL('../core/app.js', import.meta.url), 'utf8');
...
const mappingSource = await readFile(new URL('../core/pdf/pdfDataMapping.js', import.meta.url), 'utf8');
