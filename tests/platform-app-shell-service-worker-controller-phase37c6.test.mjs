...
const controllerPath = path.join(root, 'js/core/ux/serviceWorkerController.js');
...
assert.ok(serviceWorkerSource.includes("'./js/core/ux/serviceWorkerController.js'"), 'service worker must precache service worker controller');
...
const controller = await import('../js/core/ux/serviceWorkerController.js');
