...
for (const moduleId of modules) {
  const controller = read(`modules/${moduleId}/controller.js`);
...
const wastewaterIndex = read('modules/wastewater/index.js');
...
const rainwaterIndex = read('modules/rainwater/index.js');
...
const pressureView = read('modules/pressure-holding/view.js');
assert.ok(
