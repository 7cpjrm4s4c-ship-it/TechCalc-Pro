...
assert.ok(report.totals.appJsLineCount >= 600, '37C.1 must document current app.js size before decomposition.');
...
assert.match(appSource, /const lazyModules = \[/, '37C.1 must not move runtime code yet.');
