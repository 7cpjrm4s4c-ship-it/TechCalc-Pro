...
assert.match(source, /'saved:add'/, 'Surface add action must use the platform saved-record action.');
assert.match(source, /'saved:update'/, 'Surface update action must use the platform saved-record action.');
assert.match(source, /'saved:load'/, 'Surface selection must use the platform saved-record action.');
