...
import { applyEngineeringTypography, pdfHexText, sanitizeText } from '../core/pdf/pdfText.js';
...
const tableSource = fs.readFileSync(new URL('../core/pdf/authorityTables.js', import.meta.url), 'utf8');
