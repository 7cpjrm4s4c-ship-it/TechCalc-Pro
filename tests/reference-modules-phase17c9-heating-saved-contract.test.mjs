...
assert.match(runtime, /Heizung\/Kälte-compatible direct binding/, 'Platform saved records must explicitly use the heating/cooling interaction contract.');
assert.match(runtime, /root\.addEventListener\('click', handle, true\)/, 'Platform saved records must use one root capture listener like Heizung/Kälte.');
