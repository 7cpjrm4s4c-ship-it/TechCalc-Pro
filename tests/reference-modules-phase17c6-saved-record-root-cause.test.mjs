...
assert.doesNotMatch(rainwater, /data-saved-|loadAttr|toggleAttr|deleteAttr|bindSavedRecord|createSavedRecordActions/, 'Rainwater must not carry legacy SavedRecord attribute or binding patches.');
assert.doesNotMatch(wastewater, /data-saved-|loadAttr|toggleAttr|deleteAttr|bindSavedRecord|createSavedRecordActions/, 'Wastewater must not carry legacy SavedRecord attribute or binding patches.');
