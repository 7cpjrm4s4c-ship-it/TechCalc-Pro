...
assert.ok(fGasesSaveManagerCss.includes(`:root:not([data-theme='light']) .module-view[data-module='f-gases-check'] .saved-record-card.is-active::before`));
assert.ok(fGasesSaveManagerCss.includes('.tc-save-actions[data-edit-mode=\'edit\'] .action-button[data-save-mode-role=\'update\']'));
