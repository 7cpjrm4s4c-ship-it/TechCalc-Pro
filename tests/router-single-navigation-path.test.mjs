...
const navigationSource = readFileSync(new URL('../core/navigation.js', import.meta.url), 'utf8');
...
assert.match(appSource + readFileSync(new URL('../core/moduleRuntime.js', import.meta.url), 'utf8'), /renderNavigation\?\.\(moduleId\)|renderNavigation\(id\);/, 'navigation active state is rendered after successful content mount.');
