...
import { buildHxProcessRecord } from '../modules/hx-diagram/results.js';
import { updateActiveProcessFromDialog, deleteSavedProcessById } from '../modules/hx-diagram/controller.js';

assert.equal(['phase-26b2a-saved-records-update-delete-fix', 'phase-26b3-result-renderer', 'phase-26b3a2-process-immediate-render', 'phase-26b3a3-enter-tab-navigation-and-live-diagram', 'phase-26c1-diagram-renderer-extraction', 'phase-26c2-single-render-pipeline', 'phase-26c3-view-purification', 'phase-26d-final-platform-cleanup'].includes(config.migrationStatus), true);
