...
assert.match(view, /data-unit-dynamic=\"conversion\"/, 'conversion island must be declared');
assert.match(view, /data-unit-dynamic=\"result\"/, 'result island must be declared');
