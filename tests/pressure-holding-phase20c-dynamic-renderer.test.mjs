...
import { createPressureHoldingDynamicRenderer } from '../js/core/dynamicRenderer.js';
...
const dynamicSource = fs.readFileSync(path.join(rootDir, 'js/core/dynamicRenderer.js'), 'utf8');
