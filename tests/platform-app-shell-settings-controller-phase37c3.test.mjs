...
const controllerPath = path.join(root, 'core/ux/settingsController.js');
...
assert.ok(serviceWorkerSource.includes("'./core/ux/settingsController.js'"), 'service worker must precache settings controller');
