...
assert.ok(['phase-26b2-saved-records-platform-dialog', 'phase-26b2a-saved-records-update-delete-fix', 'phase-26b3-result-renderer'].includes(config.migrationStatus));
