...
for (const file of ['modules/buffer-storage/index.js']) {
...
const pressureHolding = readFileSync('modules/pressure-holding/index.js', 'utf8');
const pressureHoldingController = readFileSync('modules/pressure-holding/controller.js', 'utf8');
