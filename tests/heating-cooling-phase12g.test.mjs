...
assert.match(viewSource, /data-hc-dynamic="result"/, 'result area must have its own dynamic island.');
assert.match(viewSource, /data-hc-dynamic="input-fields"/, 'input fields must have their own dynamic island.');
