...
assert.match(config, /phase-14[d-g]-rainwater-(global-ux|global-workflow|reference-workflow|global-standard)/, 'Rainwater migration status must reflect Phase 14D or later.');
